            ...
            <div class="card login-card shadow-lg">
                <div class="card-body p-5">
                    ...
                    <form id="FormLogin" method="POST">
                         ...
                         <h6 class="fw-semibold text-dark mb-6">pao140202@gmail.com</h6>
                
                        <i class="bi bi-lock me-2"></i>Contra
                         <h6 class="fw-semibold text-dark mb-6">12345678</h6>
                        ...
                        <div class="text-center">
                            ...
                            <p class="mb-0">
                                ¿No tienes cuenta? 
                                <a href="/lopez_recuperacion_comisiones_ingSoft1/usuario" class="register-link">Regístrate aquí</a>
                            </p>
                        </div>
