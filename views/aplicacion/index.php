            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body bg-gradient" style="background: linear-gradient(90deg, #f8fafc 60%, #e3f2fd 100%);">
                    <div class="mb-4 text-center">
                        ...
                        <h3 class="fw-bold text-primary mb-0">GESTIÓN DE APLICACIONES</h3>
                    </div>
                    <form id="formAplicacion" class="p-4 bg-white rounded-3 shadow-sm border">
                        ...
                        <div class="row g-4 mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control form-control-lg" id="app_nombre_corto" name="app_nombre_corto" placeholder="Ingrese nombre corto (abreviación)" required>
                            </div>
                        </div>
